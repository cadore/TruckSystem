...
namespace TruckSystem
{
    ...
    public partial class TruckSystemRepo : Database
    {
        ...
        [ThreadStatic]
        static TruckSystemRepo _instance;
    ...
    */
    ...
    public partial class freight : TruckSystemRepo.Record<freight>
    {
        ...
        public long driver_id { get; set; }
        [Column]
        public int? number_note { get; set; }
        [Column]
        public int? number_cte { get; set; }
        [Column]
        public long company_source { get; set; }
        [Column]
        public long company_destination { get; set; }
        [Column]
        ...
        [Column]
        public decimal extra_comission { get; set; }
        [Column]
        public string observations { get; set; }
        [Column]
    ...
    public partial class accounts_to_pay : TruckSystemRepo.Record<accounts_to_pay>
    {
        ...
        public long customer_id { get; set; }
        [Column]
        public DateTime? emission_at { get; set; }
        [Column]
        public decimal value_products { get; set; }
        [Column]
        public decimal value_freight { get; set; }
        [Column]
        public decimal value_security { get; set; }
        [Column]
        public decimal value_discount { get; set; }
        [Column]
        public decimal value_ipi { get; set; }
        [Column]
        public string observations { get; set; }
        [Column]
        public long registred_by { get; set; }
        ...
        public DateTime registred_at { get; set; }
        [Column]
        public string guid_payment { get; set; }
        [Column]
        public long truck_id { get; set; }
        [Column]
        public int category_id { get; set; }
